...
export const CATEGORIES: { key: ServiceCategory; label: string }[] = [
  { key: "botox", label: "Ботокс" },
  { key: "filler", label: "Филлеры" },
  { key: "blanching", label: "Бланширование" },
  { key: "biorevitalization", label: "Биоревитализация" },
  { key: "collagen", label: "Коллаген" },
  { key: "lipolytics", label: "Липолитики" },
  { key: "cleaning", label: "Чистка" },
  { key: "peeling", label: "Пилинг" },
  { key: "consultation", label: "Консультация" },
];

export const FILLER_GROUPS: Record<string, string> = {
...
export const DIKIDI_PROFILE = "https://dikidi.net/ru/profile/katya_1788592";
export const DIKIDI_RECORDINGS = "https://dikidi.net/ru/recording/";
export const TELEGRAM_BOT = "https://t.me/Altyevabot";
export const PRIVACY_URL =
  "https://bitter-meadow-80cd.tradeban92.workers.dev/privacy.html";
export const PREFERRED_TIME_API =
  "https://unikon777.app.n8n.cloud/webhook/preferred-time";
export const LOYALTY_API =
  "https://unikon777.app.n8n.cloud/webhook/loyalty-status";
